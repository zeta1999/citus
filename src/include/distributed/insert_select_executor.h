...
extern List * AddInsertSelectCasts(List *insertTargetList, List *selectTargetList, Oid targetRelationId);
extern void RelableTargetEntryList(List *selectTargetList, List *insertTargetList);
