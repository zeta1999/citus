...
static void EnsureSupportedForeignKeyOnDistributionKey(Form_pg_constraint constraintForm);
static void EnsureSupportedForeignKeyBetweenLocalAndReferenceTable(Form_pg_constraint constraintForm,
										  ...
										  uint32 referencingColocationId)
{
	...
	foreach_oid(foreignKeyOid, foreignKeyOids)
	{
		...
		{
			EnsureSupportedForeignKeyBetweenLocalAndReferenceTable(constraintForm,
																  referencingReplicationModel,
		...
		{
			EnsureSupportedForeignKeyOnDistributionKey(constraintForm);
		}
...
static void
EnsureSupportedForeignKeyBetweenLocalAndReferenceTable(Form_pg_constraint constraintForm,
													  char referencingReplicationModel,
													  char referencedReplicationModel)
{
...
static void
EnsureSupportedForeignKeyOnDistributionKey(Form_pg_constraint constraintForm)
{
	/*
